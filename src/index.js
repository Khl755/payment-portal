...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0;font-family:system-ui,sans-serif}
    ...
    .card{background:#fff;padding:24px;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,.08)}
    ...
    .pay-btn{width:100%;padding:14px;background:#2563eb;color:#fff;border:none;border-radius:8px;font-size:16px;font-weight:600;cursor:pointer}
...
<body>
  <div class="card">
    ...
    <div class="info">
      <p><span class="label">Payoneer:</span> ${payoneerEmail}</p>
    </div>
    <button class="pay-btn" onclick="alert('Send payment to: ${payoneerEmail}')">Copy Payoneer Email</button>
    <p class="note">💡 Send payment directly to this email. Update status after payment.</p>
  </div>
</body>
</html>`;
